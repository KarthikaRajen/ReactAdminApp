...
export const HeaderNavContainer = ({apiCallsInProgress}) => {
    return (
        <nav className="navbar navbar-toggleable-sm bg-success navbar-inverse">
            <div className="container">
                ...
                <div className="collapse navbar-collapse" id="mainNav">
                    <div className="navbar-nav">
                        ...
                        <NavLink className="nav-item nav-link" activeClassName="active" to="/employees" >Employees</NavLink>
